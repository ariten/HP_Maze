...
class SideHandler:
    ...
    def question_1(self, answer):
        ...
        if answer.lower() == actual_answer:
            return ["Success", '2p8934u5', 100]  # Top Left
        else:
            return ['Incorrect', '', 0]
    ...
    def question_2(self, answer):
        ...
        if answer.lower() == actual_answer:
            return ["Success", '2p8956gc', 100]  # Bottom Left
        else:
            return ['Incorrect', '', 0]
    ...
    def question_3(self, answer):
        ...
        if answer.lower() == actual_answer:
            return ["Success", '2p894des', 100]  # Top Right
        else:
            return ['Incorrect', '', 0]
    ...
    def question_4(self, answer):
        ...
        if answer.lower() == actual_answer:
            return ["Success", '2p89k65c', 100]  # Bottom Right
        else:
            return ['Incorrect', '', 0]
